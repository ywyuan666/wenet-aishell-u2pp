...
def main():
    ...
    # Fix Python 3.14: torch.jit._check accesses __annotations__ via __getattr__
    import torch.jit._check
    _orig_check = torch.jit._check.AttributeTypeIsSupportedChecker.check
    def _patched_check(self, nn_module):
        nn_module.__dict__.setdefault('__annotations__', {})
        return _orig_check(self, nn_module)
    torch.jit._check.AttributeTypeIsSupportedChecker.check = _patched_check
